...
describe('Replaces every type of space with a standard space', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`maison\u00A0bleue, soleil\u202Fvert, charbon\u2009rouge`, `brut`, 0);
        expect(formatted).toEqual(`maison bleue, soleil vert, charbon rouge`);
    });
});
...
describe('Removes spaces after punctuations', () => {

});
describe('Ensures a space after a simple or double punctuation', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`bonjour,il fait beau`, `brut`, 9);
        expect(formatted).toEqual(`bonjour, il fait beau`);
    });
    it('in the context of brut', () => {
    ...
    it('in the context of brut', () => {
        const formatted = mo.apply(`dans le cas d'un caractère spécial),ça marche aussi`, `brut`, 9);
...
describe('Ensures a single non-breaking space before a double punctuation', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`il est vrai:nous sommes verts`, `brut`, 10);
        expect(formatted).toEqual(`il est vrai\u202F:nous sommes verts`);
    });
    it('in the context of brut', () => {
        const formatted = mo.apply(`est-il vrai?nous sommes verts`, `brut`, 10);
        expect(formatted).toEqual(`est-il vrai\u202F?nous sommes verts`);
    });
});
describe('Normalizes ordinal numbers', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`la 1ere`, `brut`, 11);
        expect(formatted).toEqual(`la 1re`);
    });
    it('in the context of brut', () => {
        const formatted = mo.apply(`la 2eme`, `brut`, 11);
        expect(formatted).toEqual(`la 2e`);
    });
});
describe('Normalizes ordinal numbers plural', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`les 2emes`, `brut`, 12);
        expect(formatted).toEqual(`les 2es`);
    });
});
describe('Ordinal numbers are exposed', () => {
    it('in the context of html', () => {
        const formatted = mo.apply(`les 2es`, `html`, 13);
...
Mr le Visconsul`, `brut`, 14);
        expect(formatted).toEqual(`Mme de Bovary
Mr le Visconsul`);
    });
    it('in the context of html', () => {
        const formatted = mo.apply(`Mme de Bovary
Mr le Visconsul`, `html`, 14);
...
describe('Change the writing of the centuries', () => {
    it('in the context of brut', () => {
        const formatted = mo.apply(`XVIIIeme siècle`, `brut`, 15);
        expect(formatted).toEqual(`XVIIIe siècle`);
    });
    it('in the context of html', () => {
        const formatted = mo.apply(`XVIIIe siècle`, `html`, 15);
        expect(formatted).toEqual(`XVIII<sup>e</sup> siècle`);
    });
    it('in the context of brut', () => {
        const formatted = mo.apply(`XVIIIème siècle`, `brut`, 15);
        expect(formatted).toEqual(`XVIIIe siècle`);
    });
    it('in the context of brut', () => {
        const formatted = mo.apply(`XVIIIe siècle`, `brut`, 15);
        expect(formatted).toEqual(`XVIIIe siècle`);
    });
});
...
MA et les institutions`, `brut`, 17);
